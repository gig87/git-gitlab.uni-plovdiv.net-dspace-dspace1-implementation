...
<body>
<a href="#create-community" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
    ...
    <g:form action="save">
        <fieldset class="form">
            ...
            <div class='fieldcontain'>
                ...
                <textarea name="shortDescription" value="" maxlength="255" id="shortDescription"></textarea>
            </div>
        </fieldset>
